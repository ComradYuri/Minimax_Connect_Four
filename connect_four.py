...
def has_won(board, symbol):
    ...
    for y in range(len(board[0])):
        for x in range(len(board) - 3):
            if board[x][y] == symbol \
                    and board[x+1][y] == symbol \
                    and board[x+2][y] == symbol \
                    and board[x+3][y] == symbol:
                return True
    ...
    for x in range(len(board)):
        for y in range(len(board[0]) - 3):
            if board[x][y] == symbol \
                    and board[x][y+1] == symbol \
                    and board[x][y+2] == symbol \
                    and board[x][y+3] == symbol:
                return True
    ...
    for x in range(len(board) - 3):
        for y in range(3, len(board[0])):
            if board[x][y] == symbol \
                    and board[x+1][y-1] == symbol \
                    and board[x+2][y-2] == symbol \
                    and board[x+3][y-3] == symbol:
                return True
